...
var StoreMetaData = &bind.MetaData{
	...
	Bin: "0x6080604052348015600e575f5ffd5b50603e80601a5f395ff3fe60806040525f5ffdfea2646970667358221220ac513ad145ca6a52df05f2630509b67a62d80d488874c19babc23b076a85752664736f6c634300081c0033",
}
...
func (_Store *StoreFilterer) FilterApproval(opts *bind.FilterOpts, tokenOwner []common.Address, spender []common.Address) (*StoreApprovalIterator, error) {
	...
	logs, sub, err := _Store.contract.FilterLogs(opts, "Approval", tokenOwnerRule, spenderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approval(address indexed tokenOwner, address indexed spender, uint256 tokens)
func (_Store *StoreFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *StoreApproval, tokenOwner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Store.contract.WatchLogs(opts, "Approval", tokenOwnerRule, spenderRule)
	if err != nil {
		return nil, err
	}
